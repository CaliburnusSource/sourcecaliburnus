...
version: 5.0.3
*/
var _sr_config="broker-config.html";
var _curl = window.location.toString();
var _cle=false;
if(/siterecruit\.comscore\.com\/sr\/windowsphone\/int_cle\.htm/i.test(_curl)){
	_sr_config="broker-config_cle.html"; 
	_cle=true; 
}
		...
		return {
			...
			*/
			...
			init: function() {
				...
				_sr.executingPath = _utils.getExecutingPath("broker.html");
